...
include '../dbconnect.php';
	...
	if (isset($_POST['delete'])){
		$id = $_POST['resid'];
		$select = "Delete FROM material where id=".$id." ";
		$conn->query($select);
	}
	...
	// print table heads//
		...
		echo ('<div class="table-responsive"><table border=1 class="table " ">
		...
		echo ("</tbody></table></div>");
			...
			echo ("<p class=reservation_table1>\"Sorry there are no Materials\"</p>");
		}
